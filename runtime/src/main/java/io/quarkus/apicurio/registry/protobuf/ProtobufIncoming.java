 ...
 *
 * <div class="warning">
 * <strong>EXPERIMENTAL:</strong> This annotation's transformation to {@code @Incoming} is currently limited
 ...
 * <p>
 * It is currently recommended to use the standard {@code @Incoming} annotation with Protobuf message types.
 * The extension will automatically detect the Protobuf types and configure the deserializer.
 * </p>
 *
 * <pre>{@code
